...
svg_shot.append("circle").attr("cx",800).attr("cy",130).attr("r", 6).style("fill", "#C7EFCF")
svg_shot.append("circle").attr("cx",800).attr("cy",160).attr("r", 6).style("fill", "#FE5F55")
svg_shot.append("text").attr("x", 820).attr("y", 130).text("Make").style("font-size", "15px").attr("alignment-baseline","middle")
svg_shot.append("text").attr("x", 820).attr("y", 160).text("Miss").style("font-size", "15px").attr("alignment-baseline","middle")
